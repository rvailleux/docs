...
2. If your company does not have an account yet, click **Subscribe**. 
 ...
 ![](../.gitbook/assets/EN-subscribing-create-company-account.png)
3. Click the **switch** to accept the Terms and the Policy then, click **Confirm**. 
 
 ![](../.gitbook/assets/EN-subscribing-agree-to-terms-conditions.png)
...
7. In the message, click the link. 
 ...
 ![](../.gitbook/assets/EN-subscribing-message-with-link.png)
...
11. Enter your bank account information and click **Next**.​ 
 ...
 ![](../.gitbook/assets/EN-portal-subscribing-payment-method.png)
