...
-  Click **Edit this contact**  - Change the information you want then, - Click **Save**. 
![](../../.gitbook/assets/EN-Diag-portal-ticket-page-edit-requester-information.png) |
| --- | --- | --- | --- |
...
| d. | Shared files | Files shared during the assistance.
 ...
 <table class="seeAlso" cellspacing="0" cellpadding="0"> <tbody> <tr> <td class="seeAlsoImageCell "><img src="../../.gitbook/assets/Apizee-see-also-icon.png"> </td> <td>  **See also&#160;**&#160;<a href="export-session-information-into-pdf.md" target="_top">Export the session information into a PDF</a>&#160;
 </td> </tr> </tbody>
...
<img src="../../.gitbook/assets/EN-Diag-portal-ticket-page-file-information-location-time.png" alt="">- If you want to share the file or download it, tick the box and click **Share **or **Download**. | ![](../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** [Share a file with the requester](../actions-during-the-video-assistance/share-and-download-files/share-a-file-with-a-requester.md) 
**See also** [Download the files - After the session in the portal](../actions-during-the-video-assistance/share-and-download-files/download-files-shared-during-assistance-session.md) |
| --- | --- |
{% hint style="info" %}
**See also** [Share a file](../video-assistance-multi/agents/actions-during-the-assistance/share-file.md) & [Download files - After the session in the portal](../embed/agents/portal/download-files.md/a/h2__2077902823)
{% endhint %}
...
![](../../.gitbook/assets/EN-Diag-public-page.png) |
| h. | Guest invironment | Information about the guest **device**, **OS** and **Web browser** | Get information about the guest type of **device**, **operating system** and **browser** to better understand the environment of the video call. |
