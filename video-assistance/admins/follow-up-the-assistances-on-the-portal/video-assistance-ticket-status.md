...
| ![Information](../../.gitbook/assets/info.png) | The agent can invite the guest again, change the date and time of the video assistance. |
| --- | --- | |
...
| ![Information](../../.gitbook/assets/info.png) | **[Time trigger - Change status to Completed](../configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md#end-transfer-notification-delay "Check the article about the configuration of this trigger")**is configured by the admininstrator. |
| --- | --- | |
...
| ![](../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** [Customize the tickets](../configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md) |
| --- | --- |
