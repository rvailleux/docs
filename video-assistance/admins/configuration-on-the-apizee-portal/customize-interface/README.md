...
The theme that is displayed by default is the [company](README.md) one.

However, you can customize the theme of one or several[services](README.md) if you need them to be different.
...
![](../../../.gitbook/assets/portal-company-information-picture.png)
    * Wallpaper The wallpaper fills the application background.
 
![](../../../.gitbook/assets/portal-company-theme-diag.png)
    * Header The header is used on the video assistance homepage.
 
![](../../../.gitbook/assets/portal-company-theme-header.png)
3. Click **Save**.
...
| ![Information](../../../.gitbook/assets/info.png) | If you create a new theme, it will not be synchronized with the default theme anymore. <br> You can [come back to the default theme](README.md#reset-to-default-theme)at any moment. |
    | --- | --- |
4. Click **Choose File**to change the:

Favicon
![](../../../.gitbook/assets/portal-customize-theme-service-diag-favicon.png)
 
Rectangular logo
![](../../../.gitbook/assets/portal-customize-theme-service-diag-rectangular-logo.png)

 Wallpaper
![](../../../.gitbook/assets/portal-customize-theme-service-diag-wallpaper.png)

Header
![](../../../.gitbook/assets/portal-customize-theme-service-diag-header.png) 
...
{% hint style="success" %}
If you changed your mind and want to come back to the [Company default theme](README.md), click **Reset** .
 
![](../../../.gitbook/assets/portal-customize-theme-reset.png)
{% endhint %}
