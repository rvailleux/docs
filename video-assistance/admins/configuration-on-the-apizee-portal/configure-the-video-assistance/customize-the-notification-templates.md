...
4. Click **Add new template**. 
 ...
 ![](../../../.gitbook/assets/EN-portal-template-notification-add.png)
...
![](../../../.gitbook/assets/portal-theme-rectangular-logo.png)
 -  in the <span id="hotspot_chrc1753445473514" class=" CHHotspot CHPopupHotspot">Company graphic theme, that is used as the default theme.</span> <img src="../../../.gitbook/assets/Portal-company-customize-graphic-theme.png" alt="">
 -  in the <span id="hotspot_chrc1753445473515" class=" CHHotspot CHPopupHotspot">service Theme tab if you want to customize this logo for a specific service.</span>  <img src="../../../.gitbook/assets/portal-customize-theme-create-new-theme-service.png" alt=""> 

    

| ![](../../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** attach-a-report-to-the-ticket.md[Customize the interface](../customize-interface/README.md) |
| --- | --- | |
