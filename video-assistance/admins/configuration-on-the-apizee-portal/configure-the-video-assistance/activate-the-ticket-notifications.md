...
Subscribe to the **DIAG - Enterprise** offer
 ...
 <table class="seeAlso" cellspacing="0" cellpadding="0"> <tbody> <tr><td>  **See also&#160;**&#160;<a href="configure-the-agents.md#h1__984823644" target="_blank">Configure the agents - Define a user role and activate the notifications</a> 
...
| ![](../../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** [Cancel a session](../../follow-up-the-assistances-on-the-portal/cancel-a-session.md) |
| --- | --- | | Canceled |
