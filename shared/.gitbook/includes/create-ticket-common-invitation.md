...
**Video assistance Multi-participants**, for example.
2. Click **New session**. 
 
 ![](../../.gitbook/assets/EN-assistance-multi-portal-click-new-session.png)
3. Enter several guests contacts: **phone numbers,** **email addresses** or **names** (linked to the **Directory** tab above).
4. Enter the **type** of request.
5. Enter the **email subject**, the ticket **reference** and add some **notes** about the reason of the request.
...
11. Click **Send**. 
 ...
 ![](../../.gitbook/assets/EN-Diag-portal-create-new-session-common-invitation-choose-template-and-preview.png)

{% hint style="success" %}
The ticket for a video session is created and an invitation is sent to every guest.
{% endhint %}
