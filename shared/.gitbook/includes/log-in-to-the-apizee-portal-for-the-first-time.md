...
You want an Apizee account and you received a message with:
  ...
  -  <span class="dxhe-resizable-table-cell"><a href="log-in-to-the-apizee-portal-for-the-first-time.md#A login and a password">A login and a password</a> 
 **Or** </span>  -  <span><a href="log-in-to-the-apizee-portal-for-the-first-time.md#A validation link and a login">A validation link and a login</a> </span>  
{% endhint %}
...
2. Enter your password twice. 
    ...
    | ![](../assets/tip.png) | Choose a **different password** that you do not use for another Website.
