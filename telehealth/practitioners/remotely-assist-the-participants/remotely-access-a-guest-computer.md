...
Once the software is launched, the remote access starts. You can control the participant keyboard and mouse. |
    ...
    If you want to know the steps that the guest will have to follow before the organizer takes remotely control of the computer, check the followong article:  ****   [Allow the organizer to remotely access my computer](../actions-during-the-teleconsultation/allow-organizer-to-remotely-access-my-computer.md)
