...
{% hint style="success" %}
**Did you know?**
 -  You can <a href="share-a-file.md" target="_blank">share again the files</a>&#160;to the participants event if the session is over.  - You can <a href="download-the-files-shared-during-the-teleconsultation.md" target="_blank">download the files</a>&#160;on your device.  
{% endhint %}
...
| ![](../../.gitbook/assets/Apizee-see-also-icon.png) | **See also**  [Send a new invitation for the same session](send-new-invitation-for-same-session.md) |
| --- | --- |
