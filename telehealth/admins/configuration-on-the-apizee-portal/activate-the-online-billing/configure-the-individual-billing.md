...
2. Click **My account**. 
 ...
 ![](../../../.gitbook/assets/EN-portal-practitioner-thombnail-profile.png)
3. Click on the **Billing** tab.
4. Under **Transfer to an individual account**, click **Create a Stripe profile**. 
...
1. Click **Update**. 
 ...
 ![](../../../.gitbook/assets/EN-stripe-activate-individual-online-billing-stripe-update-button.png)
2. Under **ID verification**, click **Verify now**. 
 
 ![](../../../.gitbook/assets/EN-stripe-activate-online-billing-verify-now.png)
3. Upload an identity document and click **Complete**. 
 
 ![](../../../.gitbook/assets/EN-stripe-activate-online-billing-ID-document.png)
4. Under **Verify home address**, click **Verify now**.
5. Upload a proof of address document and click **Continue to upload**. 
 
 ![](../../../.gitbook/assets/EN-stripe-activate-online-billing-type-of-address-document.png)
6. Tick the required boxes.
7. Click **Submit documents**. 
 
 ![](../../../.gitbook/assets/EN-stripe-activate-online-billing-address-document-submit.png)
...
1. Click **Add a new bank account**. 
 ...
 ![](../../../.gitbook/assets/EN-portal-activate-individual-online-billing-add-bank-account.png)
2. Enter the **holder name** of the bank account.
3. Enter the **international IBAN number** of the bank account.
4. Click **Continue**. 
 
 ![](../../../.gitbook/assets/EN-portal-activate-individual-online-billing-bank-account-IBAN.png)
5. Enter a **Pre-defined amount**. The amounts will display during the online billing as a quick entry. You will be able to choose between the different amounts or enter a new one.
Minimum charge: 1€.
6. Click **Save**. 
