...
1. Click **Update**. 
 ...
 ![](../../../.gitbook/assets/EN-stripe-activate-online-billing-update-button.png)
...
1. Click **Add new bank account**. 
 ...
 ![](../../../.gitbook/assets/EN-portal-activate-online-billing-add-business-account.png)
2. Enter the **holder name** of the bank account.
3. Enter the **international IBAN number** of the bank account.
4. Click **Continue**. 
 
 ![](../../../.gitbook/assets/EN-portal-activate-online-billing-business-account-IBAN.png)
5. Click **Save**.
