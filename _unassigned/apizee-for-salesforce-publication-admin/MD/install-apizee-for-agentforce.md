...
| ![](../Storage/apizee-for-salesforce-publication-admin/project-content-reuse/Apizee-see-also-icon.png) | **See also** [Enter chapter title here.](https://doc.apizee.com/articles/project-diag-help-desk-diagnostic-center/attach-a-report-to-the-ticket)<br> <br>C'est bien d'ajouter des liens externes ! Vérifiez cependant qu'ils ne sont pas déjà proposés dans le volet de droite **Related topics** dans la publication. |
| --- | --- |
