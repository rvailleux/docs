...
2. Click **Start screen sharing** if you want to share your own screen. 
 ...
 ![](../Storage/customer-engagement-user-en/EN-Diag-portal-agent-share-screen.png)
...
5. Click **Share**. 
 ...
 ![](../Storage/customer-engagement-user-en/EN-Diag-share-screen-web-browser.png)
...
A sharing request is sent to the participant. The participant screen displays when the request is accepted. 
    ...
    | ![](../Storage/customer-engagement-user-en/project-content-reuse/tip.png) | This option is available on computers only. |
    | --- | --- |
