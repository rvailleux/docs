...
| ![Information](../../.gitbook/assets/info.png) | If you create a new theme, it will not be synchronized with the default theme anymore. <br> You can [come back to the default theme](customize-interface.md#reset-to-default-theme)at any moment. |
    | --- | --- |
