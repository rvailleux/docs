...
| ![Information](../../.gitbook/assets/info.png) | **[Time trigger - Change status to Completed](../video-assistance/admins/configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md/a/end-transfer-notification-delay "Check the article about the configuration of this trigger")**is configured by the admininstrator. |
| --- | --- | |
...
| ![](../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** [Customize the tickets](../video-assistance/admins/configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md) |
| --- | --- |
