...
![](../../.gitbook/assets/EN-portal-service-assistance-list-cancel-session.png)
3. You are going to advise the guest that was invited to the video assistance:
    ...
    2. Click **Next**.
![](../../.gitbook/assets/EN-portal-diag-agent-cancel-session-choose-template-and-language.png)
    3. Add a personnal information that will be added to the message.
    4. Click **Send**.
![](../../.gitbook/assets/EN-portal-diag-agent-cancel-session-add-message-and-send.png)
4. A message displays, click **Cancel session**.

![](../../.gitbook/assets/cancel-session-confirmation.png)
...
![](../../.gitbook/assets/EN-portal-assistance-page-cancel-session-button.png)
