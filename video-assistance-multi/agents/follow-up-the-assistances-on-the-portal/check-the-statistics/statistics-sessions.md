...
They are the entries you configured in **Configuration** &gt; **Services management**. | ![](../../../.gitbook/assets/EN-portal-menu-service.png) |
...
| l. | Information | Displays the additional information about the session with:
 -  **files&#160;**shared during the session and  -  a preview of the&#160;**messages**.   | ![](../../../.gitbook/assets/FR-conf-portal-stats-session-page-information.png) |
