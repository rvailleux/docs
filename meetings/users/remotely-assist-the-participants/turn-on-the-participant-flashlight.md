| ![](../../.gitbook/assets/icon-device-mobile.png) | Available only if the participant is following the session with: <br> - an **Android smartphone**. - the **back camera** selected. |
| --- | --- |
