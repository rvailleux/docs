...
2. Click **New**.
 ![](../../.gitbook/assets/EN-portal-agenda-view-week-zoom-new.png) 

    | ![](../../.gitbook/assets/tip.png) | To change the view mode, click **Day**, **Week**, **Month**or **List**. |
    | --- | --- |
...
9. Give a name to the conference , if you want it.
10. Change the **Advanced options**, only if necessary. 
In these options:
...
11. If you chose to send this invitation by email, add a personal message. 
