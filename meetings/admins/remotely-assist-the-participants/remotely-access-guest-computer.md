...
{% hint style="info" %}
If you want to know the steps that the guest will have to follow before the organizer takes remotely control of the computer, check the followong article:  ****  [Allow the organizer to remotely access my computer](../actions-during-the-conference/allow-organizer-to-remotely-access-my-computer.md)
{% endhint %}
