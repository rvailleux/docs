...
![](../../.gitbook/assets/EN-button-invite-participant-during-session.png)
3. Enter the contact of the person you want to invite.
...
You can also invite a person to join the session by phone. Interested? Click **Show more**.
[+] [Show More](javascript:void%280%29)
 [-] [Hide](javascript:void%280%29)
 1. On the right, in the **Participants** tab, click **More**.

![](../../.gitbook/assets/EN-conf-invite-participant-during-session-button-more.png)
2. Under **Join by phone**, copy the **phone number** and the **DTMF code**.

![](../../.gitbook/assets/EN-conf-invite-participant-button-more-options.png)
