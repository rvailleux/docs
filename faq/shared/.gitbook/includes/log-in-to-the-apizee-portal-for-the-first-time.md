...
* [A login and a password](<log-in-to-the-apizee-portal-for-the-first-time.md#A login and a password>) **Or** - [A validation link and a login](<log-in-to-the-apizee-portal-for-the-first-time.md#A validation link and a login>)
{% endhint %}
...
![](<../../../.gitbook/assets/EN-create-user-message-login-password (1).png>)

1. In the message, click the **link**.
2. Enter the login and the password given by the administrator.
3. Click **Sign in**.

![](<../../../.gitbook/assets/EN-portal-sign-in-to-apizee-account (1).png>)
...
![](<../../../.gitbook/assets/EN-create-user-message-validation-link-login (1).png>)
...
![](<../../../.gitbook/assets/EN-portal-log-in-first-time-confirm-password-twice-finalize (1).png>)
