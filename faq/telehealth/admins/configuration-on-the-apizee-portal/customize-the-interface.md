...
3.  Click **Create a new theme**.&#x20;
    ...
    \|  | If you create a new theme, it will not be synchronized with the default theme anymore. You can [come back to the default theme](customize-the-interface.md#Reset-to-default-theme)at any moment. | | --- | --- |
