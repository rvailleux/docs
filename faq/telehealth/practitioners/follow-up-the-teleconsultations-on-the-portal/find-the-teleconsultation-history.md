# find-the-teleconsultation-history
...
```
| ![](../../.gitbook/assets/ok.png) | The page displays with the following information: |
| --- | --- |
```
...
* You can [share again the files](https://github.com/rvailleux/docs/tree/master/faq/telehealth/practitioners/follow-up-the-teleconsultations-on-the-portal/share-a-file.md) to the participants event if the session is over. - You can [download the files](https://github.com/rvailleux/docs/tree/master/faq/telehealth/practitioners/follow-up-the-teleconsultations-on-the-portal/download-the-files-shared-during-the-teleconsultation.md) on your device.
{% endhint %}
