...
3\. You are now ready to send an invitation to join de video call to your guest. Check the phone number that has been pre-filled from ServiceNow's Contact phone number and click on the "Send Invitation" button.
...
![](../.gitbook/assets/classicui-getting-started-servicenow-2025-02-28.png)
```

4\. In the Apizee solution, you will be automatically redirected to the detail page of the newly created **ticket**. Eventually the Guest clicks on the link they received via SMS and starts the video call.&#x20;

```
| ![](../.gitbook/assets/ok.png) | You will then be prompted with a call signal. |
| --- | --- |
```
