# communicate-colleagues-record-the-session

{% hint style="info" %}
You are an agent and you want to record the ongoing session.
{% endhint %}

1. On the right hand-side, click the **red dot** to start the video recording.

![](<../../../.gitbook/assets/Diag-portal-agent-record-session (1).png>)
