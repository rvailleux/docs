...
![](../../../../.gitbook/assets/EN-Diag-guest-share-file-before-session-click-upload-media.png) 2. Click **Transfer files** and choose the documents you want to share.

![](../../../../.gitbook/assets/EN-Diag-guest-share-file-before-session-click-upload-media2.png)

{% hint style="success" %}
The agent receives the documents. If you sent a picture, you can see a preview.
{% endhint %}
...
2\. Take a picture then, click **OK**. 3. Allow to share your geolocation.
...
![](../../../../.gitbook/assets/EN-Diag-guest-share-file-after-session-click-share-media.png) 2. Choose your document and click **Open**.
