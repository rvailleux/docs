# communicate-colleagues-take-a-picture-and-draw-on-it

{% hint style="info" %}
You are an agent during an ongoing assistance session.
{% endhint %}

1. To take a picture of the participant video, click ![](<../../../.gitbook/assets/Button-take-picture (1).png>)
...
![](<../../../.gitbook/assets/EN-Diag-portal-agent-local-shared-annotation-open-whiteboard (1).png>)
...
![](<../../../.gitbook/assets/Diag-portal-agent-whiteboard (1).png>) 4. Choose a **color**and a shape (**pen**, **arrow**, **circle**, **rectangle**) and draw on the picture. You can also annotate it with **Text**.
...
![](<../../../.gitbook/assets/EN-Diag-whiteboard-options (1).png>)
