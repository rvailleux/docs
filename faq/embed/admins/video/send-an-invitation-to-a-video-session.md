# Send an invitation message to a video session

{% hint style="info" %}
If Apizee Embed is integrated in a platform, you may have automatically the guest phone number prefilled in our invitation form. If the phone number is correct, click **Invite and start** to start the video session.
{% endhint %}
