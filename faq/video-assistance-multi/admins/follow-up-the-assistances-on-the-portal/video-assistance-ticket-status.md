...
\|  | \*\*[Time trigger - Change status to Completed](https://github.com/rvailleux/docs/tree/master/faq/video-assistance-multi/admins/video-assistance/admins/configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md/a/end-transfer-notification-delay/README.md)\*\*is configured by the admininstrator. | | --- | --- | | | **Closed** | Here are the ways a ticket can change to **Closed**:
...
|   | **See also** [Customize the tickets](https://github.com/rvailleux/docs/tree/master/faq/video-assistance-multi/admins/video-assistance/admins/configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-tickets.md) |
| - | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
