...
3.  Click **Share pointer**.
    ...
    | Loggued user view | ![](../../../.gitbook/assets/EN-conf-menu-action-loggued-user-share-pointer.png)    |
    | ----------------- | ----------------------------------------------------------------------------------- |
    | Organizer view    | ![](../../../.gitbook/assets/EN-conf-menu-action-orga-myself-tab-share-pointer.png) |
