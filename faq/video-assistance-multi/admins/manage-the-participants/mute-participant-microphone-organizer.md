# mute-participant-microphone-organizer
...
![](../../../.gitbook/assets/EN-conf-actions-guests-tab-selected.png) 3. If you are more than 2 participants, choose the name of the participant in the drop-down menu. 4. Click **Mute the participant**.

![](../../../.gitbook/assets/EN-conf-menu-action-orga-guests-tab-mute-participant.png)

```
| ![](../../.gitbook/assets/ok.png) | The participant microphone is deactivated. Nobody can hear the participant. |
| --- | --- |
```
