# remove-someone-from-ongoing-session
...
![](../../../.gitbook/assets/conf-participant-option-dots-click.png) 2. At the bottom of the list, click **Remove from conference**.

![](../../../.gitbook/assets/EN-conf-dots-participant-option-organizer-view.png)
