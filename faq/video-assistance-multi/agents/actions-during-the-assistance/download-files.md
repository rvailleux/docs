...
\[+] [Show More](https://github.com/rvailleux/docs/tree/master/faq/video-assistance-multi/agents/actions-during-the-assistance/javascript:void\(0\)/README.md) \[-] [Hide](https://github.com/rvailleux/docs/tree/master/faq/video-assistance-multi/agents/actions-during-the-assistance/javascript:void\(0\)/README.md)

1. At the bottom right, click **Download on another device**.

![](../../../.gitbook/assets/EN-conf-end-of-session-page-download-files-on-another-device-button.png) 2. Enter en email address and click **Confirm**.
