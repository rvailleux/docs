...
![](../../../.gitbook/assets/EN-conf-actions-guests-tab-selected.png) 3. If you are more than 2 participants, choose the name of the participant in the drop-down menu. 4. Click **Switch the camera**.
...
**Guest screen** ![](../../../.gitbook/assets/EN-conf-guest-notif-asking-switch-camera.png)
