...
You can also invite a person to join the session by phone. Interested? Click **Show more**. \[+] [Show More](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/actions-during-the-conference/javascript:void\(0\)/README.md) \[-] [Hide](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/actions-during-the-conference/javascript:void\(0\)/README.md)
