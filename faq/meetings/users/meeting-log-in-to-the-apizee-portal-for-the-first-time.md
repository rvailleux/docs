# meeting-log-in-to-the-apizee-portal-for-the-first-time

{% hint style="info" %}
You want an Apizee account and you received a message with:

* [A login and a password](<meeting-log-in-to-the-apizee-portal-for-the-first-time.md#A login and a password>) **Or** - [A validation link and a login](<meeting-log-in-to-the-apizee-portal-for-the-first-time.md#A validation link and a login>)
{% endhint %}
