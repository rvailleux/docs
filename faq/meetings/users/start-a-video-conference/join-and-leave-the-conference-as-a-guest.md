...
\[+] [Show More](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/start-a-video-conference/javascript:void\(0\)/README.md) \[-] [Hide](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/start-a-video-conference/javascript:void\(0\)/README.md) |  | If you want to join the conference with a phone or by QR code, click **More**.\
