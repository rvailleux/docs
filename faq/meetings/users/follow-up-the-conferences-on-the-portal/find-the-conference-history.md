...
* You can [share again the files](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/follow-up-the-conferences-on-the-portal/share-a-file.md) to the participants event if the session is over. - You can [download the files](https://github.com/rvailleux/docs/tree/master/faq/meetings/users/follow-up-the-conferences-on-the-portal/download-the-files-shared-during-the-conference.md) on your device.
{% endhint %}
