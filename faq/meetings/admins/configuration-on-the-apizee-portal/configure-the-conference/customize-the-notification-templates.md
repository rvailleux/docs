...
![](../../../../.gitbook/assets/EN-portal-conf-customize-the-template-notification-select-add-template.png) 5. Enter a name and write a short description. 6. Click **Create**.
