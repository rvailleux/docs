# Need to reinvite a guest,

Change the invitation time or the participant contact?
...
4\. Scroll down the page and click **Edit**.

![](../../../.gitbook/assets/EN-portal-conf-edit-conference-page-edit-button.png.png)
...
![](../../../.gitbook/assets/EN-portal-create-session-invitation-delegation.png) 5. Select a **Duration**, a **Start time** and**End time** **Day** and **Hour**. 6. Choose a **Reminder**, if you want it. 7. Click **Next**.

![](../../../.gitbook/assets/EN-portal-create-session-planning.png) 8. Select a **template**.

```
| ![Information](../../.gitbook/assets/info.png) | If you did not create your own template, select the default template. |
| --- | --- |

| ![](../../.gitbook/assets/Apizee-see-also-icon.png) | **See also** [Customize the notification templates](../video-assistance/admins/configuration-on-the-apizee-portal/configure-the-video-assistance/customize-the-notification-templates.md) |
| --- | --- |
```

9\. Select a **language**. 10. Click **Next.** ![](../../../.gitbook/assets/EN-portal-create-session-preview-invitation.png) 11. Give a name to the conference , if you want it. 12. Change the **Advanced options**, only if necessary. In these options: \* choose whether you want to moderate the participant entry, \* add en entry code, \* let the participant choose to enter with the camera and the microphone on or not. 13. If you chose to send this invitation by email, add a personal message.
...
![](../../../.gitbook/assets/EN-portal-create-session-finalize.png) 14. Click **Finalize**.
