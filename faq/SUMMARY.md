...
* [What languages are supported?](general/what-language-is-available.md)
* [Transfer a session from mobile to desktop](general/how-can-i-transfer-the-video-session-from-my-mobile-phone-to-my-computer.md)
* [Switch between dark and light mode](general/how-can-i-switch-from-dark-to-light-mode.md)
...
* [Reset your password](general/i-forgot-my-password-can-i-reset-it.md)
...
* [Change or cancel your subscription](general/i-want-to-change-my-subscription.md)
